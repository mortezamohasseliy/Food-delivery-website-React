function HeroMobile() {
  return (
    <div className="w-full">
      <div className="w-[90%] h-70.75 top-53.75 left-2.75 rounded-[11px]  flex flex-col items-center justify-center mx-auto bg-[#E2E2E2]">
        <p className="w-71.75 h-16.5 top-56.25 left-18 font-normal text-[12px] leading-16.5 tracking-normal text-[#03081F]">
          Order Restaurant food, takeaway and groceries.
        </p>
        <h2 className="w-80.25 h-18 top-69.75 left-13.75 font-semibold text-[34px]">
          Feast Your Senses,
          <br />
